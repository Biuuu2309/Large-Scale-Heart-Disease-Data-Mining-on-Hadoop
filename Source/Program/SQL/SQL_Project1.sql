...
(
	...
	FROM INFORMATION_SCHEMA.COLUMNS
	WHERE TABLE_NAME = 'Youtube_Test' AND ORDINAL_POSITION BETWEEN 12 AND 15
),
CTE2 AS 
(
...
(
	--Q1
	SELECT TOP ( SELECT COUNT(*) / 4 FROM Youtube_Test) likes AS likes_q1
	FROM Youtube_Test 
	ORDER BY likes ASC
), CTE3
AS
(
	--Q3
	SELECT TOP ( SELECT CAST(ROUND((COUNT(*) * 0.75), 0) AS INT) FROM Youtube_Test) likes AS likes_q3
	FROM Youtube_Test 
	ORDER BY likes ASC
)
SELECT *
...
(
	--Q1
	SELECT TOP ( SELECT COUNT(*) / 4 FROM Youtube_Test) dislikes AS dislikes_q1
	FROM Youtube_Test 
...
(
	--Q3
	SELECT TOP ( SELECT CAST(ROUND((COUNT(*) * 0.75), 0) AS INT) FROM Youtube_Test) dislikes AS dislikes_q3
	FROM Youtube_Test 
	ORDER BY dislikes ASC
)
SELECT *
...
(
	--Q1
	SELECT TOP ( SELECT COUNT(*) / 4 FROM Youtube_Test) comment_count AS comment_q1
	FROM Youtube_Test 
...
(
	--Q3
	SELECT TOP ( SELECT CAST(ROUND((COUNT(*) * 0.75), 0) AS INT) FROM Youtube_Test) comment_count AS comment_q3
	FROM Youtube_Test 
	ORDER BY comment_count ASC
)
SELECT *
